...
namespace MatrixLibrary {
	...
	public partial class NMatrix {
		...
		public NMatrix(int noRows, int noCols) {
		...
		public static NMatrix Add(NMatrix Mat1, NMatrix Mat2) { return new NMatrix(Add(Mat1.in_Mat, Mat2.in_Mat)); }
		...
		/// <returns>Sum of Mat1 and Mat2 as a Matrix object</returns>
		public static NMatrix operator +(NMatrix Mat1, NMatrix Mat2) { return new NMatrix(Add(Mat1.in_Mat, Mat2.in_Mat)); }
		#endregion
		...
		public static NMatrix Subtract(NMatrix Mat1, NMatrix Mat2) { return new NMatrix(Subtract(Mat1.in_Mat, Mat2.in_Mat)); }
		...
		/// <returns>Difference of Mat1 and Mat2 as a Matrix object</returns>
		public static NMatrix operator -(NMatrix Mat1, NMatrix Mat2) { return new NMatrix(Subtract(Mat1.in_Mat, Mat2.in_Mat)); }
		#endregion
		...
		/// </param>
		/// <returns>Mat1 multiplied by Mat2 as a Matrix object</returns>
		public static NMatrix operator *(NMatrix Mat1, NMatrix Mat2) {
			if ((Mat1.NoRows == 3) && (Mat2.NoRows == 3) &&
				(Mat1.NoCols == 1) && (Mat1.NoCols == 1)) {
				return new NMatrix(CrossProduct(Mat1.in_Mat, Mat2.in_Mat));
			}
			else {
				return new NMatrix(Multiply(Mat1.in_Mat, Mat2.in_Mat));
			}
		}
		#endregion
		...
		public static double Det(NMatrix Mat) { return Det(Mat.in_Mat); }
		#endregion
		...
		public static NMatrix Inverse(NMatrix Mat) { return new NMatrix(Inverse(Mat.in_Mat)); }
		#endregion
		...
		public static NMatrix Transpose(NMatrix Mat) { return new NMatrix(Transpose(Mat.in_Mat)); }
		#endregion
		...
		public static NMatrix SolveLinear(NMatrix MatA, NMatrix MatB) { return new NMatrix(NMatrix.SolveLinear(MatA.in_Mat, MatB.in_Mat)); }
		#endregion
		...
		public static int Rank(NMatrix Mat) { return Rank(Mat.in_Mat); }
		#endregion
		...
		public static NMatrix PINV(NMatrix Mat) { return new NMatrix(PINV(Mat.in_Mat)); }
		#endregion
		...
		/// Matrix object
		/// </returns>
		public static NMatrix operator *(NMatrix Mat, double Value) { return new NMatrix(ScalarMultiply(Value, Mat.in_Mat)); }
		...
		/// Matrix object
		/// </returns>
		public static NMatrix operator *(double Value, NMatrix Mat) { return new NMatrix(ScalarMultiply(Value, Mat.in_Mat)); }
		#endregion
		...
		/// <returns>The division of the array and the scalar as an array</returns>
		public static NMatrix ScalarDivide(double Value, NMatrix Mat) { return new NMatrix(ScalarDivide(Value, Mat.in_Mat)); }
		...
		/// </returns>
		public static NMatrix operator /(NMatrix Mat, double Value) { return new NMatrix(ScalarDivide(Value, Mat.in_Mat)); }
		#endregion
		...
		public static NMatrix CrossProduct(NMatrix V1, NMatrix V2) { return (new NMatrix((CrossProduct(V1.in_Mat, V2.in_Mat)))); }
		#endregion
		...
		/// <returns>Dot product of V1 and V2</returns>
		public static double DotProduct(NMatrix V1, NMatrix V2) { return (DotProduct(V1.in_Mat, V2.in_Mat)); }
		#endregion
		...
		public static double VectorMagnitude(NMatrix V) { return (VectorMagnitude(V.in_Mat)); }
		#endregion
		...
		/// <returns>If two matrices are equal or not</returns>
		public static bool IsEqual(NMatrix Mat1, NMatrix Mat2) { return IsEqual(Mat1.in_Mat, Mat2.in_Mat); }
		...
		/// <returns>If two matrices are equal or not</returns>
		public static bool operator ==(NMatrix Mat1, NMatrix Mat2) { return IsEqual(Mat1.in_Mat, Mat2.in_Mat); }
		...
		public override bool Equals(Object obj) {
			try { return (bool) (this == (NMatrix) obj); }
			catch { return false; }
		}
		...
		public static string PrintMat(NMatrix Mat) { return (PrintMat(Mat.in_Mat)); }
